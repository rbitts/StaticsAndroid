...
/**
 * Implements an HorizontalStackBarChart chart extending {@link com.sec.widget.Chart.view.BaseStackBarChartView}
 */
public class HorizontalStackBarChartView extends BaseStackBarChartView {
	 ...
	 * @param data {@link ArrayList} of {@link com.sec.widget.Chart.model.ChartSet} to use
	 */
	@Override
	 ...
	 *
	 * @param data Array of {@link com.sec.widget.Chart.model.ChartSet} to do the necessary preparation just
	 * before onDraw
	 */
	@Override
