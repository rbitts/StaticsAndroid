...
/**
 * Data model containing a set of {@link Bar} to be used by {@link com.sec.widget.Chart.view.BaseBarChartView}.
 */
public class BarSet extends ChartSet {
	...
	/**
	 * Add new {@link com.sec.widget.Chart.model.Bar} from a string and a float.
	 *
	 * @param label new {@link com.sec.widget.Chart.model.Bar}'s label
	 * @param value new {@link com.sec.widget.Chart.model.Bar}'s value
	 */
	...
	/**
	 * Add new {@link com.sec.widget.Chart.model.Bar}.
	 *
	 * @param bar new nonnull {@link com.sec.widget.Chart.model.Bar}
	 */
	 ...
	 *
	 * @return {@link com.sec.widget.Chart.model.BarSet} color.
	 */
	public int getColor() {
	 ...
	 * @param color
	 *
	 * @return {@link com.sec.widget.Chart.model.BarSet} self-reference.
	 */
